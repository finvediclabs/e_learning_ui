...
<div class="chatbot" :class="{ open: isOpen, maximized: isMaximized, minimized: !isMaximized && isOpen }">
  ...
  <div class="welcome-content">
    <div class="welcome-image-container">
      <q-img :src="Drona_White" alt="Drona" :class="['welcome-image', { 'welcome-image-maximized': isMaximized }]" />
    </div>
    <div>
      <p class="welcome-text">Hi! I am Drona, your AI virtual assistant.<br>Ask me about Fintech!</p>
    </div>
  </div>
</div>
  ...
  <div v-for="message in messages" :key="message.id" :class="message.type">
    <div class="message-label" v-if="message.type === 'incoming'">Drona</div>
  ...
  <div v-if="isTyping" class="typing-preloader">
    <div class="message-label">Drona</div>
    <div class="type-anim">
  <span>T</span>
  <span>y</span>
  <span>p</span>
   ...
   data() {
     return {
      ...
      //  originalWelcomeMessage: "Hi! I am Drona, your AI virtual assistant.<br>Ask me about Fintech?",
       minimizedWelcomeMessage: "Hi! I am Drona, your AI virtual assistant.<br>Ask me about Fintech!"
