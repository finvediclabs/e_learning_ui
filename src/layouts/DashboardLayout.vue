...
{ label: "Assignments", value: "assignment", icon: 'task' },
      ...
      allAccess: [ "profile", "course","hackathon","hackathons","assignment","help","home","labs","library","homeProfile","reports","channel","class-room","calendar","hackathon","groupDiscussion","books","videos","presentations","chat","read-pdf","program","seminarEvent","seminar"],
  ...
  if (!access.length) {
    ...
    updateBackgroundStyle() {
      ...
      if  (this.$route.path === '/elearning') {
        ...
        this.backgroundStyle = 'Home_BackgroundStyle'; // Apply the background style class
      }
