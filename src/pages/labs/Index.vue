            ...
            <div class="q-pa-md">
              ...
              <div style="display: flex;align-items: center;justify-content: center;flex-direction: column;">
                ...
                <div class="row justify-center q-pa-md">
                  <q-btn color="primary" no-caps class="sub-btn q-ml-sm fin-br-8" style="min-width:150px"
                    label="FinVedic Dojo" href="https://gurukul.finvedic.com/dojo/" target="_blank" />
                </div>
              </div>
              <!--  -->
          ...
          <div class="col-6">
            <q-form @submit="onSubmit" ref="form" class="q-pa-md">
              <div class="row">
                <div class="col-12 col-md-12 q-pa-sm" style="margin-left: auto; margin-right: auto;">
                  ...
                  <div class="image-btn-container">
                    <q-btn v-ripple v-model="selectedOS" toggle :flat="selectedOS !== 'Windows'"
                      :color="selectedOS === 'Windows' ? 'green' : 'white'" class="image-btn"
                    ...
                    <q-btn v-ripple v-model="selectedOS" toggle :flat="selectedOS !== 'Linux'"
                      :color="selectedOS === 'Linux' ? 'green' : 'white'" class="image-btn"
              ...
              <div style="display: flex;align-items: center;justify-content: center;flex-direction: column;">
                ...
                <div class="row justify-center q-pa-md">
                  <q-btn color="primary" no-caps class="sub-btn q-ml-sm fin-br-8" style="min-width:150px"
                    label="Requeste For VM" type="submit" :disabled="!formIsValid" />
                </div>
              </div>
            </q-form>
          </div>
