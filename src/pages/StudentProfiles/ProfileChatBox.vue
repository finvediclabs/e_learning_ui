            ...
            <div id="chat-page">
              <div class="chat-container-wrapper">
                <div ref="chatscrollContainer" class="chat-container" v-scroll-bottom>
                  <div>
                    <div ref="connectingElement" style="color: green;text-align: center;">Connecting...</div>
                    <ul id="vedichivemessageArea">
...
displayMessages() {
    const messageArea = document.querySelector('#vedichivemessageArea');
...
displaySingleMessage(receivedMessage) {
      ...
      usernameElement.style.color = "#8899d8";
      usernameElement.style.fontSize = "1.2rem";
      messageElement.appendChild(usernameElement);

      const timeElement = document.createElement('p');
        timeElement.style.color='skyblue';
        const timestamp = receivedMessage.time;
        const date = dayjs(timestamp);
        const dateFormatted = date.format('DD/MM/YY'); 
        const timeFormatted = date.format('HH:mm:ss');   
        timeElement.textContent = `${dateFormatted} ${timeFormatted}`;
