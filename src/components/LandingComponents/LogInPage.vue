...
/>
          ...
          <q-btn no-caps class="full-width sub-btn text-body1 text-weight-medium sign-up" padding="md" label="Login" type="submit" style="background-color: #2528CB !important; color: #ffffff;"
            :disable="loading">
